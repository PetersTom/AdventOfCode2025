...
print(paths_from("dac", "fft"))
print(paths_from("fft", "dac"))

# fft always before dac
svr_to_fft = paths_from("svr", "fft")
fft_to_dac = paths_from("fft", "dac")
dac_to_out = paths_from("dac", "out")
